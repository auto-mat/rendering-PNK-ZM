...
import_data "$OVERPASS_URL?map?bbox=14.318619,48.902192,14.628983,49.063519" false
render tiles_PNK "48.99349 14.43839 48.94335 14.53418" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Ceske Budejovice"

import_data "$OVERPASS_URL?map?bbox=17.836252,49.744629,18.615067,49.946802" false
...
import_data "$OVERPASS_URL?map?bbox=17.023087,49.400612,17.557279,49.676623" false
...
import_data "$OVERPASS_URL?map?bbox=16.383362,49.062169,16.848907,49.31438" false
...
import_data "$OVERPASS_URL?map?bbox=15.345154,49.865432,16.254272,50.385757" false
...
import_data "$OVERPASS_URL?map?bbox=14.906387,50.649896,15.344467,50.843671" false
...
import_data "$OVERPASS_URL?map?bbox=13.857828,50.545204,14.417946,50.87902" false
...
import_data "$OVERPASS_URL?map?bbox=15.457764,49.335862,15.696716,49.461876" false
render tiles_PNK "49.4239 15.5491 49.3792 15.6227" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Jihlava"

import_data "$OVERPASS_URL?map?bbox=17.346039,49.004547,17.585335,49.131633" false
render tiles_PNK "49.0933 17.4101 49.0536 17.4976" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Uherske Hradiste"

import_data "$OVERPASS_URL?map?bbox=17.433191,49.138142,17.780106,49.287525" false
...
import_data "$OVERPASS_URL?map?bbox=14.812952,49.034361,15.196945,49.248445" false
render tiles_PNK "49.160514 14.974313 49.124763 15.035583" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Jindrichuv hradec"

import_data "$OVERPASS_URL?map?bbox=17.981608,49.579173,18.041527,49.610347" false
