...
import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=14.018,49.762,15.5,50.318" false
...
#render Plzen
import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=12.936401,49.45295,13.914185,49.967123" false
...
import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=14.318619,48.902192,14.628983,49.063519" false
render tiles_PNK "48.99349 14.43839 48.94335 14.53418" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Ceske Budejovice"

import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=17.836252,49.744629,18.615067,49.946802" false
...
import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=17.023087,49.400612,17.557279,49.676623" false
...
import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=16.383362,49.062169,16.848907,49.31438" false
...
import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=15.345154,49.865432,16.254272,50.385757" false
...
import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=14.906387,50.649896,15.344467,50.843671" false
...
import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=13.857828,50.545204,14.417946,50.87902" false
...
import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=15.457764,49.335862,15.696716,49.461876" false
render tiles_PNK "49.4239 15.5491 49.3792 15.6227" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Jihlava"

import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=17.346039,49.004547,17.585335,49.131633" false
render tiles_PNK "49.0933 17.4101 49.0536 17.4976" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Uherske Hradiste"

import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=17.433191,49.138142,17.780106,49.287525" false
...
import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=14.812952,49.034361,15.196945,49.248445" false
render tiles_PNK "49.160514 14.974313 49.124763 15.035583" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Jindrichuv hradec"

import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=17.981608,49.579173,18.041527,49.610347" false
...
import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=17.573662,49.463327,17.895699,49.635731" false
render tiles_PNK "49.581613 17.684415 49.521065 17.787649" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Hranice"

import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=16.755524,48.671455,17.037735,48.840091" false
render tiles_PNK "48.788111 16.835378 48.727564 16.938612" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Breclav"

import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=16.045361,50.297619,16.248779,50.412182" false
render tiles_PNK "50.379511 16.103021 50.323605 16.190663" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Nove mesto nad Metuji"

import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=17.90102,49.532896,18.11903,49.656627" false
render tiles_PNK "49.621247 17.963927 49.572271 18.051998" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Novy Jicin"

import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=15.904427,48.761847,16.204491,48.95069" false
render tiles_PNK "48.913013 15.968297 48.800388 16.158374" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Znojmo"

import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=14.730949,50.318285,15.074959,50.506877" false
render tiles_PNK "50.464303,14.856777,50.376668,14.964409" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Mladá boleslav"

import_data "http://www.overpass-api.de/api/xapi_meta?map?bbox=13.956413,50.443622,14.257507,50.608844" false
