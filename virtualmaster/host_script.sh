...
import_data "http://www.overpass-api.de/api/xapi?map?bbox=14.018,49.762,15.5,50.318" false
...
import_data "http://www.overpass-api.de/api/xapi?map?bbox=17.573662,49.463327,17.895699,49.635731" false
render tiles_PNK "49.581613 17.684415 49.521065 17.787649" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Hranice"

import_data "http://www.overpass-api.de/api/xapi?map?bbox=16.755524,48.671455,17.037735,48.840091" false
render tiles_PNK "48.788111 16.835378 48.727564 16.938612" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Breclav"

import_data "http://www.overpass-api.de/api/xapi?map?bbox=16.045361,50.297619,16.248779,50.412182" false
render tiles_PNK "50.379511 16.103021 50.323605 16.190663" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Nove mesto nad Metuji"

import_data "http://www.overpass-api.de/api/xapi?map?bbox=17.90102,49.532896,18.11903,49.656627" false
render tiles_PNK "49.621247 17.963927 49.572271 18.051998" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Novy Jicin"

import_data "http://www.overpass-api.de/api/xapi?map?bbox=15.904427,48.761847,16.204491,48.95069" false
render tiles_PNK "48.913013 15.968297 48.800388 16.158374" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Znojmo"

import_data "http://www.overpass-api.de/api/xapi?map?bbox=14.730949,50.318285,15.074959,50.506877" false
render tiles_PNK "50.464303,14.856777,50.376668,14.964409" 14 18 "../../Devel/mapnik/my_styles/MTB-main.xml" "Mladá boleslav"

import_data "http://www.overpass-api.de/api/xapi?map?bbox=13.956413,50.443622,14.257507,50.608844" false
